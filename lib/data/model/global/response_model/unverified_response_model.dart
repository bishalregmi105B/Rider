...
class Data {
  ...
  String? riderVerified;
  String? riderVerificationStatus;
  GlobalUser? user;

  Data({this.isBan, this.emailVerified, this.mobileVerified, this.donationVerified, this.riderVerified, this.riderVerificationStatus, this.user});
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        riderVerified: json["rider_verified"]?.toString() ?? "0",
        riderVerificationStatus: json["rider_verification_status"]?.toString(),
