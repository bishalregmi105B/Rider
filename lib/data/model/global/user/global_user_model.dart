class GlobalUser {
  ...
  String? ev;
  String? sv;
  String? dv; // Driver/Document Verified (for drivers)
  String? rvStatus; // Rider Verification Status (0=unverified, 1=verified, 2=pending, 3=rejected)
  String? donationVerified; // Donation Verified (new field)
  String? agreementSigned; // Agreement Signed status (0=not signed, 1=signed)
  ...
  factory GlobalUser.fromJson(Map<String, dynamic> json) => GlobalUser(
        ...
        rvStatus: json["rv_status"]?.toString() ?? "0",
