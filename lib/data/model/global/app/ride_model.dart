...
class RideModel {
  ...
  factory RideModel.fromJson(Map<String, dynamic> json) => RideModel(
        ...
        isScheduled: json["is_scheduled"] == null ? null : json["is_scheduled"].toString(),
        scheduledTime: json["scheduled_time"] == null ? null : json["scheduled_time"].toString(),
        notificationSent: json["notification_sent"] == null ? null : json["notification_sent"].toString(),
        notificationSentAt: json["notification_sent_at"] == null ? null : json["notification_sent_at"].toString(),
