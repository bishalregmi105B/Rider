...
import 'package:ovorideuser/data/controller/rider_kyc_controller/rider_kyc_controller.dart';
...
import 'package:ovorideuser/presentation/components/checkbox/custom_check_box.dart';
import 'package:ovorideuser/presentation/components/custom_drop_down_button_with_text_field.dart';
import 'package:ovorideuser/presentation/components/custom_loader/custom_loader.dart';
import 'package:ovorideuser/presentation/components/custom_radio_button.dart';
...
import 'package:ovorideuser/presentation/components/text/label_text_with_instructions.dart';
import 'package:ovorideuser/presentation/screens/rider_profile_verification/widget/already_verified_widget.dart';
...
class RiderProfileVerificationScreen extends StatefulWidget {
  const RiderProfileVerificationScreen({super.key});

  @override
  State<RiderProfileVerificationScreen> createState() => _RiderProfileVerificationScreenState();
}

class _RiderProfileVerificationScreenState extends State<RiderProfileVerificationScreen> {
  final formKey = GlobalKey<FormState>();
  @override
  void initState() {
    Get.put(RiderVerificationKycRepo(apiClient: Get.find()));
    Get.put(RiderKycController(repo: Get.find()));
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<RiderKycController>().beforeInitLoadKycData();
    });
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RiderKycController>(
      builder: (controller) {
        return GestureDetector(
          ...
          child: Scaffold(
            appBar: CustomAppBar(
              isShowBackBtn: true,
              title: MyStrings.riderDocumentVerification.tr,
            ),
            body: SizedBox(
              ...
              child: controller.isLoading
                  ...
                  : controller.isAlreadyVerified
                      ...
                      : controller.isAlreadyPending
                          ? const AlreadyVerifiedWidget(
                              isPending: true,
                              title: MyStrings.riderVerificationUnderReviewMsg,
                            )
