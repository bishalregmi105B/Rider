...
import 'package:ovorideuser/data/controller/common/network_connectivity_controller.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => DriverRepo(apiClient: Get.find()));
  Get.lazyPut(() => NearbyDriversController(driverRepo: Get.find()));
